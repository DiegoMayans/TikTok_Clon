...
const Upload = () => {
  ...
  return (
    <div className="flex w-full h-full absolute left-0 top-[68px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center">
      <div className="bg-white rounded-lg lg:h-[80vh] xl:w-[61%] flex gap-6 flex-wrap justify-center xl:justify-between items-center p-14 pt-6">
        <div>
          <div>
          ...
          w-[260px] h-[460px] p-10 cursor-pointer hover:border-red-300 
          hover:bg-gray-100"
          >
            {isLoading ? (
              <p>Uploading...</p>
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          >
            ...
            <option className="outline-none capitalize bg-white text-gray-700 text-base p-2 hover:bg-slate-300">
              Other
            </option>
          </select>
